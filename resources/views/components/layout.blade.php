...
<html class="lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-[rgb(10,10,10)] flex flex-col gap-y-10 justify-center mx-5 my-3 lg:mx-100">
        ...
        <nav class="sticky border-2 border-[rgb(70,70,70)] bg-[rgb(50,50,50)] w-full rounded-4xl p-5 min-w-80 sm:min-w-100">
            <ul class="flex flex-row gap-5 justify-between text-white mx-3 sm:mx-10">
