...
<html class="scroll-smooth">
    ...
    <body class="bg-[rgb(0,0,0)] px-5 py-3 scroll-smooth">
        ...
        <div class="max-w-6xl mx-auto w-full">
            <nav class="sticky liquid-panel top-3 left-0 w-full rounded-4xl p-5 min-w-80 sm:min-w-100 mb-15 md:mb-10 z-50 transition-all duration-500 opacity-100 translate-y-0 starting:opacity-50 starting:-translate-y-10 overflow-hidden">
                <div class="flex flex-row gap-5 justify-between text-white mx-3 sm:mx-10">
                    <span id="indicator" class="absolute liquid-panel w-25 md:w-50 h-full inset-0 rounded-4xl transition-all duration-500 ease-in-out"></span>
