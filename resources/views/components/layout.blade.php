        ...
        <div class="max-w-6xl mx-auto w-full">
            <nav class="sticky liquid-panel top-3 left-0 w-full rounded-4xl p-5 min-w-80 sm:min-w-100 mb-15 md:mb-10 z-50 transition-all duration-500 opacity-100 translate-y-0 starting:opacity-50 starting:-translate-y-10">
                <div class="flex flex-row gap-5 justify-between text-white mx-3 sm:mx-10">
                    ...
                    <a href="#history" class="flex gap-2 cursor-pointer">
            ...
            <footer class="mt-15 sm:mt-10 bg-[rgb(20,20,20)] text-[clamp(0.9rem,1vw,1rem)] liquid-glass w-full left-0 text-center">
                <p class="text-white">
                    @ 2026 John Robert Sevillena. All rights reserved.
                </p>
            </footer>
        </div>
